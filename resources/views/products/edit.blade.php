                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="price" class="form-control" value="{{ $product->price }}" min="1000" step="500">
                        </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="description" class="form-control" rows="3" placeholder="Jelaskan kegunaan dan manfaat produk ini...">{{ $product->description }}</textarea>
                    </div>
